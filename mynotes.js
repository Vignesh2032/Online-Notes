$(function(){
	...
	var activeNote = 0;
	var editMode = false;
    // load notes on pageload: Ajax call to loadnotes.php
    $.ajax({
        url: "loadnotes.php",
    ...
    // click on done after editing: load the notes again
	$("#done").click(function(){
    ...
    // click on edit: go to edit mode (show delete button, reduce the size of the notes ...)
	$("#edit").click(function(){
		// switch to edit mode
		editMode = true;
    ...
    // functions
		...
		function clickonNote(){
			$(".noteheader").click(function(){
				if(!editMode){
					//update activeNote variable to id of the note.
					activeNote = $(this).attr("id");
					
					//fill the text area with a content
		...
		function clickonDelete(){
			$(".delete").click(function(){
				...
				$.ajax({
					url: "deletenote.php",
					type: "POST",
					// we need to send the id of the note.
